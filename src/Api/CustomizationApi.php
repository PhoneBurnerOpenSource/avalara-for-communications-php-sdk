...
class CustomizationApi
{
     ...
     * @param  \PhoneBurner\AvalaraAFC\Model\ClientProfileConfigTypes $item_type Item Type  Examples:    Configuration, Bundle, Exclusion, Override, All (optional)
     *
     * @throws \PhoneBurner\AvalaraAFC\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \PhoneBurner\AvalaraAFC\Model\ClientProfileConfigResponse
     */
     ...
     * @throws \PhoneBurner\AvalaraAFC\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \PhoneBurner\AvalaraAFC\Model\ClientProfileConfigResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiV2ProfilesGetProfilesGetWithHttpInfo($requested_client_id = null, $requested_profile_id = null, $item_type = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\PhoneBurner\AvalaraAFC\Model\ClientProfileConfigResponse' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\PhoneBurner\AvalaraAFC\Model\ClientProfileConfigResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\PhoneBurner\AvalaraAFC\Model\ClientProfileConfigResponse';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\PhoneBurner\AvalaraAFC\Model\ClientProfileConfigResponse',
     ...
     */
    protected function apiV2ProfilesGetProfilesGetRequest($requested_client_id = null, $requested_profile_id = null, $item_type = null)
    {
