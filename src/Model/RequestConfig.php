 ...
 *
 * @category Class
 * @description Container class for json properties associated with v2.CalcTaxes request configuration options
 * @package  PhoneBurner\AvalaraAFC
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RequestConfig implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RequestConfig';
    ...
    {
        $this->container['retnb'] = isset($data['retnb']) ? $data['retnb'] : null;
        $this->container['retext'] = isset($data['retext']) ? $data['retext'] : null;
     ...
     * @return bool|null
     */
    public function getRetnb()
    {
        return $this->container['retnb'];
    }
     ...
     * @return $this
     */
    public function setRetnb($retnb)
    {
        $this->container['retnb'] = $retnb;
